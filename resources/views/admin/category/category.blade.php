        ...
        <div class="row page-titles">
            <div class="col-md-8 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0 d-inline-block menu-tab">
                    <a href="/admin/category" class="@if(!isset($request->active) || $request->active == '1') active-page @endif">Активные категории</a>
                </h3>
                <h3 class="text-themecolor m-b-0 m-t-0 d-inline-block menu-tab second-tab" >
                    <a href="/admin/category?active=0" class="@if($request->active == '0') active-page @endif">Неактивные категории</a>
                </h3>
                    ...
                    <table id="category_datatable" class="table table-bordered table-striped">
                        ...
                        @foreach($row as $key => $val)
                            ...
                            <tr>
                                <td> {{ $key + 1 }}</td>
                                <td>
                                    <a class="object-name" href="/gallery?category={{\App\Http\Helpers::getTranslatedSlugRu($val->category_name_ru)}}">
