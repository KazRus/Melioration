<div class="col-md-12">
    <div class="img-container">
        <img id="crop_image" src="{{ $row->product_image }}" alt="Picture" style="width:100%">
    </div>
</div>
<div class="col-md-12">
...
<div class="row" id="actions">
    ...
    <div class="col-md-12 docs-toggles">
        ...
        <a class="btn btn-success btn-block" data-toggle="tooltip" href="javascript:void(0)" onclick="saveCropImage()">Сохранить</a>
